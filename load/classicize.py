...
if (f):
    ...
    if "fix_load" not in f:
        ...
        new_f = re.sub(r'"br"\]', r'"br", "bibl", "quote", "q", "title", "p", "lg", "reg", "hi", "name", "placeName", "ref"]', new_f, flags=re.S)
        show.progress()
...
if (f):
    ...
    if 'fix_load' not in f:
        ...
        content = '\
\n    allowed_tags = set(["head", "item", "quote", "p", "div", "foreign", "milestone", "note", "span", "philoHighlight", "w", "author", "i", "title", "itype", "tns", "gen", "bibl", "orth", "pron", "abbr", "sense", "gramGrp", "gram", "q", "sp", "cit", "date", "placeName", "etym", "pos", "l"])\
