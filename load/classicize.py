...
if (f):
    ...
    if 'fix_load' not in f:
        ...
        content = '\
\n    allowed_tags = set(["head", "item", "quote", "p", "div", "foreign", "milestone", "note", "span", "philoHighlight", "w", "author", "i", "title", "itype", "tns", "gen", "bibl", "orth", "pron", "abbr", "sense", "gramGrp", "Grp", "cit", "date", "placeName", "etym"])\
