...
from perseus_preproc import preproc
from token_aligner_filter import *
...
PerseusLoadFilters = [get_word_counts, perseus_id_morph_tokens, index_word_attributes("lemma","pos"), generate_words_sorted, make_object_ancestors, make_sorted_toms, concat_milestones, fix_card_milestones, prev_next_obj, generate_pages, prev_next_page, generate_refs, generate_graphics, generate_lines, make_max_id, store_words_and_philo_ids]
#PerseusLoadFilters = [normalize_unicode_raw_words, make_word_counts, perseus_align_morph_tokens(lexicon_db), index_word_attributes("lemma","pos"), generate_words_sorted, make_object_ancestors, make_sorted_toms, concat_milestones, fix_card_milestones, prev_next_obj, generate_pages, prev_next_page, generate_refs, generate_graphics, generate_lines, make_max_id, store_words_and_philo_ids]

def set_load_filters(load_filters=PerseusLoadFilters, navigable_objects=DefaultNavigableObjects, lexicon_db=""):
    ...
    for load_filter in load_filters:
        ...
        elif load_filter.__name__ == "perseus_id_morph_tokens":
            filters.append(load_filter(lexicon_db))
        else:
